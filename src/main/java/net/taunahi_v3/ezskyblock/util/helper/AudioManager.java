                ...
                try {
                    ...
                    switch (TaunahiConfig.failsafeSoundSelected) {
                        case 0:
                            ...
                            break;
                        case 1:
                            inputStream = AudioSystem.getAudioInputStream(getClass().getResource("/taunahi_helper/sounds/staff_check_voice_notification.wav"));
                            break;
                        case 2:
                            inputStream = AudioSystem.getAudioInputStream(getClass().getResource("/taunahi_helper/sounds/metal_pipe.wav"));
                            break;
                        case 3:
                            inputStream = AudioSystem.getAudioInputStream(getClass().getResource("/taunahi_helper/sounds/AAAAAAAAAA.wav"));
                            break;
                        case 4:
                            inputStream = AudioSystem.getAudioInputStream(getClass().getResource("/taunahi_helper/sounds/loud_buzz.wav"));
                            break;
                    }
                    if (inputStream == null) {
