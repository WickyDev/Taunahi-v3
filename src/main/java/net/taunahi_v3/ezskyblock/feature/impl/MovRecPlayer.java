...
import net.taunahi.ezskyblockscripts.util.OldRotationUtils;
...
public class MovRecPlayer implements IFeature {
    ...
    public MovRecPlayer() {
        ...
        try {
            resourceFiles = getResourceFiles("/taunahi/movrec");
            ...
            for (String file : resourceFiles) {
                ...
                InputStream inputStream = Taunahi.class.getResourceAsStream(file);
...
//        LogUtils.sendSuccess("easeTo: " + (movement.yaw + yawDifference));
    ...
    private List<String> getResourceFiles(String path) throws IOException {
        ...
        FileSystem fs;
        URL url = Taunahi.class.getResource(path);
        if (url == null) {
            return filenames;
        }
        try {
            ...
            if ("file".equals(uri.getScheme())) {
                myPath = Paths.get(Objects.requireNonNull(Taunahi.class.getResource(path)).toURI());
            } else {
