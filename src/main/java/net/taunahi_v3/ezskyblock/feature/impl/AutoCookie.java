...
public class AutoCookie implements IFeature {
    ...
    public boolean isToggled() {
        return TaunahiConfig.autoCookie;
    }
                ...
                switch (bazaarState) {
                    ...
                    case GO_BAZAAR:
                        ...
                        if (AngleUtils.smallestAngleDifference(mc.thePlayer.rotationYaw, rotationNeeded2.getYaw()) > 4 ||
                            ...
                            rotation.easeTo(new RotationConfiguration(rotationNeeded2, TaunahiConfig.getRandomRotationTime(), null));
                            break;
                        }
                    ...
                    case CLICK_ODDITIES:
                        ...
                        setBazaarState(BazaarState.CLICK_COOKIE);
                        autoCookieDelay.schedule(TaunahiConfig.getRandomGUIMacroDelay());
                        break;
                    case CLICK_COOKIE:
                        if (mc.currentScreen == null) {
                            autoCookieDelay.schedule(getRandomDelay());
