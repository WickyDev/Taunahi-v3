package net.taunahi_v3.ezskyblock.hud;
...
public class ProfitCalculatorHUD extends BasicHud {
    ...
    public void addLines() {
        ...
        lines.add(new Tuple<>(ProfitCalculator.getInstance().getRealProfitString(), "/taunahi_helper/textures/gui/profit.png"));
        lines.add(new Tuple<>(ProfitCalculator.getInstance().getProfitPerHourString(), "/taunahi_helper/textures/gui/profithr.png"));
        lines.add(new Tuple<>(ProfitCalculator.getInstance().getBPS(), "/taunahi_helper/textures/gui/bps.png"));
        lines.add(new Tuple<>(LogUtils.getRuntimeFormat(), "/taunahi_helper/textures/gui/runtime.png"));
